...
export const LeaderTextCard: React.FC<LeaderTextCardProps> = ({
  ...
  return (
    ...
    >
      <Link
        to={itemSlug}
        className="group relative w-full rounded-[16px] sm:rounded-[20px] overflow-hidden bg-white border border-slate-200/90 hover:border-taiz-sky/50 shadow-soft hover:shadow-medium p-3 sm:p-4 flex flex-row items-center gap-3 sm:gap-4 transition-all duration-300 block"
      >
        {/* Top Accent Line */}
        ...
        <div className="w-24 h-24 sm:w-32 sm:h-28 shrink-0 rounded-xl overflow-hidden bg-slate-100 border border-slate-200/70 relative">
          <img
        ...
        <div className="flex-1 min-w-0 flex flex-col justify-between self-stretch">
          ...
          <div className="flex items-center justify-between gap-2 z-10 mb-1">
            <div className="flex items-center gap-2">
              {/* Category Tag */}
              <span className="bg-taiz-royal/10 text-taiz-royal text-[10px] sm:text-[11px] font-bold px-2 py-0.5 rounded-md flex items-center gap-1 font-cairo">
                <BookOpen className="w-3 h-3 text-taiz-sky" />
                <span>نص</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className={`w-6.5 h-6.5 sm:w-7 sm:h-7 rounded-full flex items-center justify-center border border-slate-200 transition-all ${
                  isFavorited
              ...
              <button
                onClick={handleShare}
                className="w-6.5 h-6.5 sm:w-7 sm:h-7 rounded-full bg-slate-50 hover:bg-slate-100 text-slate-500 hover:text-slate-700 flex items-center justify-center border border-slate-200 transition-all"
                title="مشاركة"
              >
          ...
          <div className="relative z-10 flex items-center justify-between pt-1.5 border-t border-slate-100 mt-1 text-text-muted text-[10px] sm:text-[11px]">
