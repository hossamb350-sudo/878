...
import { LeaderItem } from "./pages/leader/LeaderItem";
import { WatchItem } from "./pages/watch/WatchItem";
import { Quran } from "./pages/quran/Quran";
import { Events } from "./pages/events/Events";
import { Articles } from "./pages/articles/Articles";
import { ArticleDetail } from "./pages/articles/ArticleDetail";
import { Admin } from "./pages/admin/Admin";
import { ActivityDetail } from "./pages/events/ActivityDetail";
import { Search } from "./pages/search/Search";
import { WeatherDetail } from "./pages/weather/WeatherDetail";
import { PrayerTimesDetail } from "./pages/prayer-times/PrayerTimesDetail";
